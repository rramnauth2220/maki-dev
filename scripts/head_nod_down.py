...
########################
## Head (partial) nodding behavior
##
## Description: from neutral, MAKI nods down only
##
## TODO: 
...
class headNod( headTiltBaseBehavior ):
	...
	def __init__(self, verbose_debug, ros_pub):
		...
		headNod.v1 = False ## UP --> MID --> DOWN --> MID
		headNod.v2 = False ## UP --> MID_DOWN --> MID
		headNod.v3 = False ## //
		headNod.v4 = True

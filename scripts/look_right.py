...
########################
## Maki-ro looks at Rosy behavior
##
## Description: from neutral, MAKI turns to its right
##	and turns head up to look at Rosy's face
########################
class lookRosy( headTiltBaseBehavior ):
	...
	def __init__(self, verbose_debug, ros_pub):
		...
		self.look_at = "HPGP" + str(HP_EXPERIMENTER) + "HTGP" + str(HT_EXPERIMENTER) + str(SC_SET_IPT) + str( ipt_turn) + TERM_CHAR_SEND
	...
	def macroLookAtRosy( self ):
		...
		print("====================HP_EXPERIMENTER VALUE: {}==================".format(HP_EXPERIMENTER))
